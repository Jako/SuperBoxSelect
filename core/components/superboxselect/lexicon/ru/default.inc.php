...
$_lang['superboxselect.className'] = 'Название класса';
$_lang['superboxselect.className_desc'] = 'Имя класса объекта xPDO, из которого извлекаются данные. Используйте полное имя класса, например MyNamespace\MyPackage\MyClass, в зависимости от пакета xPDO.';
$_lang['superboxselect.customtable'] = 'Стол на заказ';
...
$_lang['superboxselect.packageName'] = 'Название пакета';
$_lang['superboxselect.packageName_desc'] = 'Имя пакета xPDO. Не требуется в MODX 3.x для пакетов с bootstrap.php или для пакетов расширения MODX 2.x.';
...
$_lang['superboxselect.selectedFields'] = 'Выбранные поля';
$_lang['superboxselect.selectedFields_desc'] = 'Список полей для выбора из таблицы, разделенный запятыми. Поле первичного ключа добавлять не нужно, оно всегда выбрано. Вы можете использовать эти поля в шаблоне поля и в столбце сортировки. Первое поле автоматически используется для сортировки.';
