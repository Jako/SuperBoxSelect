...
$_lang['superboxselect.className_desc'] = 'Please use the fully qualified class name, e.g. MyNamespace\\MyPackage\\MyClass';
...
$_lang['superboxselect.selectedFields'] = 'Fields to select';
$_lang['superboxselect.selectedFields_desc'] = 'Comma separated list of fields to select from the table. You do not need to add the primary key field, it is always selected. You can use these fields in the template and sorting options.';
